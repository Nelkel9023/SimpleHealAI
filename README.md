...
SimpleHeal is a lightweight healing tool for World of Warcraft 1.12.1. It provides automated targeting and spell rank selection to optimize healing efficiency and output.
...
*   **Cleansing Logic**: Automatically detects and prioritizes dispelling debuffs your class can handle.
*   **Incoming Heal Awareness**: Prevents overlapping heals by tracking pending casts.

## Commands

*   `/heal`: Performs the smart healing action.
*   `/heal emergency`: Performs emergency healing using highest available ranks.
...
*   **Heal Threshold**: Configure the health percentage at which healing begins.
*   **Enable Cleansing**: Toggle automatic dispelling of harmful debuffs.
*   **Low Mana Emote**: Toggle and set the threshold for automatic mana notifications.

## Installation

1.  Ensure SuperWoW and UnitXP are installed.
2.  Place the `SimpleHeal` folder into your `Interface\AddOns` directory.
